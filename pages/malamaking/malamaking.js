    ...
    onLoad: function(options) {
        if (options && options.mubanId) {
            ...
            this.setData({
				...
				viewHeight: app.windowHeight - app.globalData.topbarHeight-72,
            ...
            success: function(res) {
                if (res.data) {
                    ...
                    if (data.status == 1) {
                        ...
                        wx.navigateTo({
                            url: `/pages/malaresults/malaresults?picUrl=${data.imgurl}&mubanId=${_this.mubanId}&imgurl=${_this.imgurl}&type=${_this.imgtype}`,
                        })
