...
Page({
    ...
    gotomaking: function (e) {
        ...
        wx.navigateTo({
            url: `/pages/malamaking/malamaking?mubanId=${this.data.contentArr[index].id}&imgurl=${this.data.contentArr[index].xiaotu_url}&type=${this.data.contentArr[index].type}&width=${this.data.contentArr[index].img_width}&height=${this.data.contentArr[index].img_height}`,
        })
    },
