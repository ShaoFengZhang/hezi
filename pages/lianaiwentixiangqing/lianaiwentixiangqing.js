...
Page({
    ...
    submitCommetn: function() {
		...
		let _this = this;
		let url = loginApi.domin + '/qinggan/index.php/Home/Xiaochengxu/evaluate';
    ...
    submitquestion: function() {
        ...
        let _this = this;
		let url = loginApi.domin + '/qinggan/index.php/Home/Xiaochengxu/answer';
        loginApi.requestUrl(_this, url, "POST", {
    ...
    loadQuestionDetails: function(id) {
        let _this = this;
        let url = loginApi.domin + '/qinggan/index.php/Home/Xiaochengxu/question_detail';
        loginApi.requestUrl(_this, url, "POST", {
            "id": id,
        }, function(res) {
            if (res.status == 1) {
    ...
    questioOver: function(id) {
        let _this = this;
        let url = loginApi.domin + '/qinggan/index.php/Home/Xiaochengxu/count';
        loginApi.requestUrl(_this, url, "POST", {
            "id": id,
        }, function(res) {
            if (res.status == 1) {
